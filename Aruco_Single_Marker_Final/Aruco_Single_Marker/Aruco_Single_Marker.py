...
data_gamma = [1, 1 / 1.5, 1.5, 1 / 2, 2,1 / 2.2 ,2.2]#默认初始gamma值
...
while True:
    ...
    gray_frame = frame#cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY) #-- remember, OpenCV stores color images in Blue, Green, Red
