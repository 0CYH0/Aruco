...
def he_test():
    ...
    :return:
    '''
    path = "F:/Teacher_Smart_Car_Project/Aruco/picture/freedom.jpg"
    img = cv2.imread(path)
    ...
    # gamma校正
    img_gamma = gamma_adjust(img, gamma = 1/2.2)

    # gamma 校正 hsv
    img_gamma_hsv=gamma_adjust(img,gamma = 1/2.2,is_hsv=True)
